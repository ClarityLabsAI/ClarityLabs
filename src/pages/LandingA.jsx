...
const LandingA = () => {
  return (
    <LandingLayout title="Start Building Your Defense to AI">
      ...
      >
        <p>
          Enterprises are facing a seismic shift. Artificial intelligence is becoming an effectiveness multiplier that will redefine industries.
        </p>
        ...
        <ul className="space-y-3 mt-2">
            ...
            >
              <p>
                Your company's historical data and proprietary knowledge are a treasure trove, if you can access it. Whatever you structure right now, start creating a permanent record that no competitor can catch up to.
              </p>
              
              <div className="pt-6">
                  <h4 className="text-xl text-brand-gold-light font-bold font-sans mb-2">Play With AI, Not Against It</h4>
                  <p>
                    Enable AI on your integrated company knowledge. Automate tasks and enable a systemic evolution of how your business operates. When your data is structured, AI becomes a partner that understands your context, history, and goals.
                  </p>
              </div>
            </Section>
