      ...
      <div className="relative bg-black border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="relative z-10">
            {/* Point 1 */}
            <TextBlock title="Enterprise Data is a Mess" onVisible={() => setActiveStep(1)}>
              <p>
            ...
            {/* Point 2 */}
            <TextBlock title="Our AI Layer Unlocks Your Enterprise Knowledge" onVisible={() => setActiveStep(2)}>
              <p>
