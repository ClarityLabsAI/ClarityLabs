...
const TextBlock = ({ title, children, onVisible, step }) => (
    <motion.div 
    ...
    >
        ...
        {/* Mobile Visual (Inline - Between Title and Text) */}
        <div className="block lg:hidden w-full h-[300px] mb-8">
            <VisualBurden step={step} transparent={true} />
        </div>
      ...
      <div className="relative bg-black border-b border-white/10">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="relative z-10">
                  {/* Point 1 */}
                  <TextBlock title="Enterprise Data is a Mess" step={1} onVisible={() => setActiveStep(1)}>
                    <p>
                  ...
                  {/* Point 2 */}
                  <TextBlock title="Our AI Layer Unlocks Your Enterprise Knowledge" step={2} onVisible={() => setActiveStep(2)}>
                    <p>
                  ...
                  {/* Point 3 */}
                  <TextBlock title="The Bedrock for Automation" step={3} onVisible={() => setActiveStep(3)}>
                    <p>
                      This is the bedrock to unlocking AI on your enterprise knowledge. Once structured, the possibilities are endless.
                    </p>
