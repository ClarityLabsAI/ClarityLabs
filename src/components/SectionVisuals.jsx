...
export const VisualBurden = ({ step = 1, transparent = false }) => {
            ...
            content: (
                <>
                    <div className="h-6 bg-gray-700 border-b border-gray-700 flex items-center px-2">
                        <span className="text-[9px] text-gray-400">spec_2019_final_final.doc</span>
                    </div>
    ...
    const chaoticPos = [
        ...
        { bottom: "4rem", left: "3rem", width: "9rem", height: "7rem", zIndex: 20 }, // DB
        { top: "3rem", right: "6rem", width: "11rem", height: "8rem", zIndex: 30 }, // Email
        { top: "2.5rem", left: "8rem", width: "10rem", height: "10rem", zIndex: 30 }, // Word - Raised
        { bottom: "3rem", left: "50%", x: "-50%", width: "14rem", height: "10rem", zIndex: 40 }, // Excel
        { bottom: "5rem", right: "2.5rem", width: "9rem", height: "6rem", zIndex: 50 }, // Audio
    ];
    ...
    const getOrganizedStyle = (i) => {
        ...
        return {
            top: "auto",
            bottom: "50px", // Raised significantly
            left: `${leftPos}%`,
    ...
    return (
        <SimpleContainer transparent={transparent}>
            <div className="w-full h-full relative overflow-hidden p-4 transition-all duration-1000">
                ...
                <motion.div
                    className="absolute top-[35%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-20"
                ...
                {windows.map((win, i) => {
                    ...
                    return (
                        <motion.div
                            key={i}
                            className={`absolute bg-gray-800 border rounded shadow-xl z-30 flex flex-col ${win.color}`}
...
export const VisualScanTimeline = () => {
    const phases = [
        {
            title: "Kickoff",
            time: "1h with IT",
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {phases.map((phase, i) => (
                        <motion.div
                            ...
                            className="border border-white/10 bg-white/5 rounded-lg p-4 shadow-lg backdrop-blur-sm"
                        >
